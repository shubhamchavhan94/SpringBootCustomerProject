...
public class CustomerHandlerException {
	...
	{
		CustomerException customerException = new CustomerException(System.currentTimeMillis(), HttpStatus.NOT_FOUND, customerNotFoundException.getMessage());
	...
	{
		CustomerException customerException = new CustomerException(System.currentTimeMillis(), HttpStatus.NOT_FOUND, exception.getMessage());
